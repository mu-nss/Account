...
class TransactionServiceTest {
    public static final long USE_AMOUNT = 200L; // 사용금액
    ...
    void successUseBalance() {
        ...
        // then
        verify(transactionRepository, times(1)).save(captor.capture()); // 저장하는지 확인
    ...
    void cancelTransaction_TransactionAccountUmMatch() {
        // given
        AccountUser user = AccountUser.builder()
                .name("Pobi").build();
        user.setId(12L);
